...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{email-endpoint.png}
    \caption{Petición de prueba para el envío de correo desde la interfaz de Swagger UI.}
    \label{fig:test_mail_send}
\end{figure}

El destinatario del correo recibe una notificación en su bandeja de entrada detallando el cuerpo del mensaje redactado, confirmando la correcta comunicación con los servidores SMTP de Google. Además de poder observarse en la parte superior derecha que la cuenta de correo revisada no es la misma que la perteneciente al emisor del correo.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{email-recibido.png}
